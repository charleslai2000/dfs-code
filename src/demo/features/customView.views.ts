...
class CustomEditorPane extends SimpleEditorPane {
  ...
  public async renderInput(input: EditorInput): Promise<monaco.IDisposable> {
...
class CustomEditorInput extends SimpleEditorInput implements IEditorCloseHandler {
  ...
  public async confirm(): Promise<number> {
...
registerEditorSerializer(
  ...
  class implements IEditorSerializer {
    ...
    public serialize(editor: CustomEditorInput): string | undefined {
    ...
    public deserialize(instantiationService: IInstantiationService, serializedEditor: string): EditorInput | undefined {
